...
const About = () => {
  return (
    <div id ="about" className='max-w-[1140px] h-[1140px] m-auto w-full p-4 py-16 '>
      ...
      <h1 className=' text-2xl'>Making public commute a hassle free, easily acceessbile experience.
      <ol>
     <li>Sharing routes</li>
     <li>Making moving though the city a breeze</li>
     <li>Providing live updates to arrival and departures times.</li>
     <li>Providing a view of routes and instant price comparisons</li>
     <li>Day pass, weekly and monthly card/text purchases completely online</li>
      </ol></h1>
     ...
     <h1 className=' grid-cols-2 text-2xl'>Making public commute a hassle free, easily acceessbile experience. <li>Sharing routes</li>
     <li>Making moving though the city a breeze</li><li>Providing live updates to arrival and departures times.</li><li>Providing a view of routes and instant price comparisons</li><li>Day pass, weekly and monthly card/text purchases completely online</li></h1>
       ...
       <div className='grid grid-cols-2' >
       <img src ="https://transitapp.com/img/5.0/home/go.gif"alt =" " className='w-[500px] md:h-full  p-2 max-h-[590px] h-[300px] object-contain '  />
      </div>
